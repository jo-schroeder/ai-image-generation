...
![Top set of four images where a dog progressively turns to static, Bottom set of four images where static progressively turns into a dog](./img/fork-example.png){width=600}
...
- Dedicate more time to active learning and discussion
  ...
  - Add a variety of scenarios to address new context (e.g. AI image generation in new contexts)
